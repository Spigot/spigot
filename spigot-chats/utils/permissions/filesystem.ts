...
// Always ask when Spigot tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Spigot for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Spigot)
