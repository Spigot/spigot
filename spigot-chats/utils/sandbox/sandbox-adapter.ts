...
/**
 * Resolve Spigot-specific path patterns for sandbox-runtime.
 *
 * Spigot uses special path prefixes in permission rules:
...
/**
 * Convert Spigot settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Spigot started)
