...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Spigot was first started on this machine
  ...
  // Spigot usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Spigot OAuth token
  ...
  // Spigot hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
