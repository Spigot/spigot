...
const APP_NAME = 'Spigot URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Spigot URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Spigot Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Spigot
